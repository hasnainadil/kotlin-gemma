...
val TASK_LLM_FUNCTION_CALLING =
  Task(
    type = TaskType.LLM_FUNCTION_CALLING,
    icon = Icons.Outlined.Functions,
    models = mutableListOf(),
    description = "Chat with on-device LLMs that can call external functions like weather and time",
    docUrl = "https://ai.google.dev/edge/ai-edge-fc",
    sourceCodeUrl =
      "https://github.com/google-ai-edge/gallery/blob/main/Android/src/app/src/main/java/com/google/ai/edge/gallery/functioncalling/FunctionCallingHelper.kt",
    textInputPlaceHolderRes = R.string.text_input_placeholder_llm_chat,
  )

val TASK_LLM_DISEASE_SCANNING =
  Task(
    type = TaskType.LLM_DISEASE_SCANNING,
    icon = Icons.Outlined.Mms,
    models = mutableListOf(),
    description = "Scan images for potential diseases using on-device AI",
    docUrl = "https://ai.google.dev/edge/mediapipe/solutions/genai/llm_inference/android",
    sourceCodeUrl =
      "https://github.com/google-ai-edge/gallery/blob/main/Android/src/app/src/main/java/com/google/ai/edge/gallery/ui/llmchat/LlmChatModelHelper.kt",
    textInputPlaceHolderRes = R.string.text_input_placeholder_llm_chat,
