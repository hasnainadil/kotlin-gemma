    ...
    Card(shape = RoundedCornerShape(28.dp)) {
      Column(modifier = Modifier.padding(horizontal = 24.dp)) {
        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState()).weight(1f, fill = false)) {
          // Short content.
          MarkdownText(
            "By using GemmaVetCare, you accept (1) the [Google Terms of Service](https://policies.google.com/terms), and (2) the GemmaVetCare App Terms of Service" +
          ...
          if (viewFullTerms) {
            MarkdownText(
              "Your use of any Gemma models in the GemmaVetCare app is governed by the [Gemma Terms of Use](https://ai.google.dev/gemma/terms), including the [Gemma Prohibited Use Policy](https://ai.google.dev/gemma/prohibited_use_policy). By using, reproducing, modifying, distributing, performing, or displaying any portion or element of Gemma or any Gemma model derivatives, you agree to be bound by [those terms](https://ai.google.dev/gemma/terms) and that policy.\n" +
                "\n" +
                "Your use of any other AI models in GemmaVetCare is subject to the terms and conditions that apply to that model. Please read those terms carefully before using any third-party model.\n" +
                "\n" +
                "GemmaVetCare may collect anonymous usage data about your use of the app and share such data with Google. We encourage you to read our [Privacy Policy](https://policies.google.com/privacy). It explains what information we collect, why we collect it, and how you can update, manage, export, and delete your information.",
              smallFontSize = true,
